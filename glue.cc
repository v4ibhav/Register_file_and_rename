...
void REN__renamer(uint64_t n_log_regs, uint64_t n_phys_regs, uint64_t n_branches, uint64_t n_active) {
	REN = new renamer(n_log_regs, n_phys_regs, n_branches, n_active);
}
